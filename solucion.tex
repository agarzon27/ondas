...
\begin{figure}[h]
  \centering
  \includegraphics[width=6cm]{fourier_nh_bc.pdf}
  \caption{Aproximaci\'on por serie de Fourier.}
  \label{fig:fourier_nh_bc}
\end{figure}


\lstinputlisting[language=Python, caption=Aproximaci\'on por serie de Fourier, label=code:fourier_nh_bc]{fourier_nh_bc.py}
